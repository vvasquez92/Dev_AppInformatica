                                ...
                                <div class="col-md-12 center-margin">
                                    <form class="form-horizontal form-label-left" id="formulario" name="formulario">
                                        ...
                                        <div class="col-md-6 col-sm-12 col-xs-12 form-group">
                                            ...
                                            <input type="text" class="form-control" name="nomequipo" id="nomequipo" required="">
                                        </div>
                                        <div class="col-md-6 col-sm-12 col-xs-12 form-group">
                                            <label>DIRECCION IP ASIGNADA</label>
                                            <input type="text" class="form-control" name="ip" id="ip" data-inputmask="'mask' : '999.999.999.999'" required="">
                                        </div>
                                        <div class="col-md-6 col-sm-12 col-xs-12 form-group">
                                            <label>USUARIO</label>
