            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div id="listadomarcas" class="x_content">

                    <table id="tblmarcas" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                      <thead>
                        <tr>
                          <th>Opciones</th>
                          <th>Marca</th>                         
                  ...
                  <div id="formulariomarcas" class="x_content">
                    <br />
                    ...
                    <div class="col-md-12 center-margin">
                      ...
                      <div class="col-md-12 col-sm-12 col-xs-12 form-group">
                        <label>Marca</label>
                          <input type="hidden" id="idmarcacom" name="idmarcacom" class="form-control">
...
require 'footer.php';
?>
<script type="text/javascript" src="scripts/marcacom.js"></script>
<?php 
}
ob_end_flush();
?>