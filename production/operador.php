            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div id="listadooperadores" class="x_content">

                    <table id="tbloperadores" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                      <thead>
                        <tr>
                          <th>Opciones</th>
                          <th>Operador</th>                         
                  ...
                  <div id="formulariooperadores" class="x_content">
                    <br />
                    ...
                    <div class="col-md-12 center-margin">
                      ...
                      <div class="col-md-12 col-sm-12 col-xs-12 form-group">
                        <label>Operador</label>
                          <input type="hidden" id="idoperador" name="idoperador" class="form-control">
