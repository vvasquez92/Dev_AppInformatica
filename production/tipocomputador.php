            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div id="listadotipocompu" class="x_content">

                    <table id="tbltipocompu" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                      <thead>
                        <tr>
                          <th>Opciones</th>
                          <th>Tipo</th>                         
                  ...
                  <div id="formulariotipocompu" class="x_content">
                    <br />
                    ...
                    <div class="col-md-12 center-margin">
                      ...
                      <div class="col-md-12 col-sm-12 col-xs-12 form-group">
                        <label>Tipo</label>
                          <input type="hidden" id="idtcomputador" name="idtcomputador" class="form-control">
...
require 'footer.php';
?>
<script type="text/javascript" src="scripts/tipocomputador.js"></script>
<?php 
}
ob_end_flush();
?>